...
class ProductsTest {
	...
	public void setUp() throws Exception {
		//preparing test data
		ha1 = new HomeAppliances(101, "Rice Cooker X19", "Deanne", 55.50 ,1);
		ha2 = new HomeAppliances(102, "Electric Oven R55", "Hanz",105.20 ,3);
		hf1 = new HomeFurnitures(201, "Storage Cabinet", "Alurea", 350.75,"Oak");
		hf2 = new HomeFurnitures(202, "Study Table", "Chapmans", 95.50,"Rosewood");
	...
	public void retrieveAllHomeAppliancesTest(){
		...
		String tesOutput = String.format("%-15s %-25s %-25s %-15s %-15s\n", "101", "Rice Cooker X19", "Deanne", "55.50", "1");
		tesOutput += String.format("%-15s %-25s %-25s %-15s %-15s\n", "102", "Electric Oven R55", "Hanz", "105.20", "3");
		
		assertEquals("Test that ViewAllHomeAppliancesList", testOutput, allAppliances);
	}
	...
	public void retrieveAllHomeFurnituresTest(){
		...
		String allAppliances = ProductsMain.retrieveHomeAppliances(haList);
		String tesOutput = String.format("%-15s %-25s %-25s %-15s %-15s\n", "201", "Storage Cabinet", "Alurea", "350.75", "Oak");
		tesOutput += String.format("%-15s %-25s %-25s %-15s %-15s\n", "202", "Study Table", "Chapmans", "95.50", "Rosewood");
